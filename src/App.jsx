...
function App() {
  ...
  return (
    <div className="bodys brightness-50   min-h-screen flex flex-col justify-center items-center text-center">
      <div className="card backdrop-opacity-60  backdrop-contrast-50 bg-white/30 border-2 bg-blue-600 rounded-lg p-8 max-w-lg  w-full shadow-lg backdrop-blur-lg relative shadow-slate-200">
